    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.CharField(choices=[('GAMES', 'games'), ('TERROR', 'terror'), ('COMEDIA', 'comédia'), ('LEAGUE OF LEGENDS', 'league of legends'), ('TEORIAS RICK E MORTY', 'teorias rick e morty'), ('MARVEL SNAP', 'marvel snap'), ('SUPER HEROIS', 'super-heróis')], max_length=20)),
